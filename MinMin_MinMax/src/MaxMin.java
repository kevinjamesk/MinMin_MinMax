...
public class MaxMin {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            vmlist = VmsCreator.createRequiredVms(Config.reqVms, brokerId);
            ...
            cloudletList = CloudletCreator.createUserCloudlet(Config.reqTasks, brokerId);
    ...
    private static Datacenter createDatacenter(String name) {
        return DataCenterCreator.createUserDatacenter(name, Config.reqVms);
    }
